...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <h6>Total Rating: ${totalRating}</h6>
...
const updateTaxAndCharge = () => {
  ...
  if (priceConverted > 200) {
    ...
    setInnerText("total-tax", Number((parseFloat(priceConverted * 0.2)).toFixed(2)));
    // setInnerText("total-tax", priceConverted * 0.2);
  }
  if (priceConverted > 400) {
    setInnerText("delivery-charge", 50);
    setInnerText("total-tax", Number((parseFloat(priceConverted * 0.3)).toFixed(2)));
  }
  if (priceConverted > 500) {
    setInnerText("delivery-charge", 60);
    setInnerText("total-tax", Number((parseFloat(priceConverted * 0.4)).toFixed(2)));
  }
};
...
const updateTotal = () => {
  ...
  document.getElementById("total").innerText = Number((parseFloat(grandTotal)).toFixed(2));
};
